...
# Ensure the API key is retrieved properly
api_key = "AIzaSyDKCUK95yC7-KxkIZV_E_2hD0E9xaxb5V4"
...
model = genai.GenerativeModel(
    model_name="tunedModels/improvedfinancialadvicedataset-cttcw7vzr",
...
response_text = give_personal_advice(user_input)
print(response_text)